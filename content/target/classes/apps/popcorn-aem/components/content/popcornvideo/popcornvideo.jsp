...
%><%@ page import="com.day.cq.dam.api.Asset,
    ...
    if (asset != null) {
        ...
        //Modification to out of the box Video component. Needed to make this data available to the timeline functionality
        request.setAttribute("video_id", id);
        request.setAttribute("video_title", asset.getMetadataValue("dc:title")!= "" ? asset.getMetadataValue("dc:title") : asset.getName());
...
<%-- Begin modification from out of the box component. If we are in edit mode show the timeline --%>
<c:if test="${isAuthor && not isPreviewMode}">
<cq:include script="timeline.jsp"/>
</c:if>
<%-- End modification from out of the box component--%>

<%--Moved this down so the attribute would be available in the included script --%>
<%
